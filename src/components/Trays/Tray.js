...
const Tray = (props) => {
  ...
  useEffect(() => {
    const fetchTray = async () => {
      setLoading(true)
      const response = await get(`/trays/${id}`)
    ...
    <div>
      {!loading ? 
        <div className={classes.verticalMain}>
          <a className={classes.itemMain}>{tray.name}</a>
          <div className={classes.horizontal}>
            <div className={classes.vertical}>
              <div className={classes.vertical}>
                <div className={classes.horizontal}>
                  <a className={classes.description}>{tray.description}</a>
                </div>
                <div className={classes.horizontal}>
                  <a className={classes.itemName}>Expiration: </a>
                  <a className={classes.item}>{tray.expiration}</a>
                </div>
                <div className={classes.horizontal}>
                  <a className={classes.itemName}>Price: </a>
                  <a className={classes.item}>${tray.price}</a>
                </div>
                <div className={classes.horizontal}>
                  <a className={classes.itemName}>Size: </a>
                  <a className={classes.item}>{tray.size}</a>
                </div>
                <div className={classes.horizontal}>
              ...
              <div className={classes.courses}>
                <a className={classes.coursesTitle}> Courses:</a>
